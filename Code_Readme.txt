...
Requirements- Please upload 4 csvs which are hoodies.csv, jeans.csv, hoodiescolors.csv, jeanscolors.csv, before you run the notebook. These csvs have also been obtained from data scraped in the first part of the notebook.
